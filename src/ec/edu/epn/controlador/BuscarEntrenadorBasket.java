...
@WebServlet("Vistas/Deportes/BuscarEntrenadorBasket")
public class BuscarEntrenadorBasket extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private List<Entrenador> entrenadores=null;

    public BuscarEntrenadorBasket() {
        super();
...
//   		String prod = request.getParameter("nombreBusqueda");
		...
		//		System.out.print("nombreBusqueda");
				...
				getServletConfig().getServletContext().getRequestDispatcher("/Vistas/Deportes/BasketEntrenadores.jsp").forward(request, response);
