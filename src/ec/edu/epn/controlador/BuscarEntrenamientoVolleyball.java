...
@WebServlet("Vistas/Deportes/BuscarEntrenamientoVolleyball")
public class BuscarEntrenamientoVolleyball extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private List<Entrenamiento> entrenamientos=null;

    public BuscarEntrenamientoVolleyball() {
        super();
...
//   		String prod = request.getParameter("nombreBusqueda");
		...
		//		System.out.print("nombreBusqueda");
				...
				getServletConfig().getServletContext().getRequestDispatcher("/Vistas/Deportes/VolleyballEntrenamientos.jsp").forward(request, response);
