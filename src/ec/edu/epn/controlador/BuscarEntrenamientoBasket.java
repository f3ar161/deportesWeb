...
@WebServlet("Vistas/Deportes/BuscarEntrenamientoBasket")
public class BuscarEntrenamientoBasket extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private List<Entrenamiento> entrenamientos=null;

    public BuscarEntrenamientoBasket() {
        super();
...
//   		String prod = request.getParameter("nombreBusqueda");
		...
		//		System.out.print("nombreBusqueda");
				...
				getServletConfig().getServletContext().getRequestDispatcher("/Vistas/Deportes/BasketEntrenamientos.jsp").forward(request, response);
