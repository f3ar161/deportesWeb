...
@WebServlet("Vistas/Deportes/BuscarEntrenamientoFutbol")
public class BuscarEntrenamientoFutbol extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private List<Entrenamiento> entrenamientos=null;

    public BuscarEntrenamientoFutbol() {
        super();
...
//   		String prod = request.getParameter("nombreBusqueda");
		...
		//		System.out.print("nombreBusqueda");
				...
				getServletConfig().getServletContext().getRequestDispatcher("/Vistas/Deportes/FutbolEntrenamientos.jsp").forward(request, response);
