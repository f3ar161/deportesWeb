...
@WebServlet("Vistas/Deportes/BuscarEntrenadorFutbol")
public class BuscarEntrenadorFutbol extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private List<Entrenador> entrenadores=null;

    public BuscarEntrenadorFutbol() {
        super();
...
//   		String prod = request.getParameter("nombreBusqueda");
		...
		//		System.out.print("nombreBusqueda");
				...
				getServletConfig().getServletContext().getRequestDispatcher("/Vistas/Deportes/FutbolEntrenadores.jsp").forward(request, response);
