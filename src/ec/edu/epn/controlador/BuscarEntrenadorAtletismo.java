...
@WebServlet("Vistas/Deportes/BuscarEntrenador")
public class BuscarEntrenadorAtletismo extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private List<Entrenador> entrenadores=null;

    public BuscarEntrenadorAtletismo() {
        super();
...
//   		String prod = request.getParameter("nombreBusqueda");
		...
		//		System.out.print("nombreBusqueda");
				...
				getServletConfig().getServletContext().getRequestDispatcher("/Vistas/Deportes/AtletismoEntrenadores.jsp").forward(request, response);
