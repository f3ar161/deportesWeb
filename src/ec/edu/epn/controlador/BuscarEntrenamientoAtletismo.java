...
@WebServlet("Vistas/Deportes/BuscarEntrenamiento")
public class BuscarEntrenamientoAtletismo extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private List<Entrenamiento> entrenamientos=null;

    public BuscarEntrenamientoAtletismo() {
        super();
...
//   		String prod = request.getParameter("nombreBusqueda");
		...
		//		System.out.print("nombreBusqueda");
				...
				getServletConfig().getServletContext().getRequestDispatcher("/Vistas/Deportes/AtletismoEntrenamientos.jsp").forward(request, response);
