...
@WebServlet("Vistas/Deportes/BuscarEntrenadorVolleyball")
public class BuscarEntrenadorVolleyball extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private List<Entrenador> entrenadores=null;

    public BuscarEntrenadorVolleyball() {
        super();
...
//   		String prod = request.getParameter("nombreBusqueda");
		...
		//		System.out.print("nombreBusqueda");
				...
				getServletConfig().getServletContext().getRequestDispatcher("/Vistas/Deportes/VolleyballEntrenadores.jsp").forward(request, response);
